...
export function ServicesShowcase({ innovations }: ServicesShowcaseProps) {
    ...
    <div ref={containerRef}>
      ...
      <div className="relative hidden h-screen w-full overflow-hidden lg:block">
        ...
        <div ref={trackRef} className="will-change-transform">
          {innovations.map((area, i) => (
            ...
            >
              <ServicesSlide area={area} isActive={activeIndex === i} />
            </div>
          ))}
        </div>

        {/* Progress dots */}
        <ServicesProgressDots
      ...
      <div className="lg:hidden">
        {innovations.map((area) => (
          ...
          >
            <ServicesSlide area={area} isActive={true} />
          </motion.div>
        ))}
      </div>
    </div>
